...
public class UsuarioDao {
    ...
    public Boolean criar(Usuario user) throws SQLException {
        if(this.getUsuarioPorLogin(user.getLogin()) == null){
...
//        }
////        System.out.println(heroiDao.getHeroisPorIdUsuario(usuarioSQL.getId()));
//        List<Heroi> listaHeroi = heroiDao.getHeroisPorIdUsuario(usuarioSQL.getId());
//        for(Heroi heroiAutal : listaHeroi){
//            System.out.println(heroiAutal.getPersonName());
//        }
//    }
}
